...
----------------- UI -----------------
local mod_id = "Ride Minecart" -- This should match the name of your mod's folder.
mod_settings_version = 1 -- This is a magic global that can be used to migrate settings to new mod versions. call mod_settings_get_version() before mod_settings_update() to get the old value. 
mod_settings = 
{
	{
		id = "ui_Break",
		ui_name = "Minecart Strength",
		ui_description = "How strong is the minecart",
		value_default = "3",
		values = { 
			{"max","Invincible"},
			{"4","Strong"}, 
	...
	--[[
	{
		id = "ui_Telekenetic",
		ui_name = "Telekenetic",
		ui_description = "Can the minecart be affected by telekenetic kick?",
		value_default = true,
